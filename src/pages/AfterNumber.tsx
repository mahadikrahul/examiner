...
export default function AfterNumber() {
  ...
  const generateQuestions = () => {
    ...
    for (let i = 0; i < TOTAL; i++) {
      // Avoid end since there's no "after" number
      const num = randomInt(start, Math.max(start, end - 1));
  ...
  return (
    <div className="worksheet-page">
      ...
      <h1>After Number ({start}–{end})</h1>
      <p className="instructions">Write the number that comes after the given number.</p>
