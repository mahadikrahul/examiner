...
export default function DescendingOrder() {
  ...
  return (
    <div className="worksheet-page">
      ...
      <h1>Descending Order ({start}–{end})</h1>
      <p className="instructions">Arrange the given numbers in descending order (largest to smallest).</p>
